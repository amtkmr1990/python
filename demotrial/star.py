...
def merge(left="C:\\out\\Concatenated.csv", right="C:\\CS\\station-info.txt",
          output="C:\\out\\Concatenated-Merged.csv"):
    ...
    mergedDf = pandas.merge ( leftDf, rightDf.ix[:, ["USAF_WBAN", "STATION NAME", "LAT", "LON"]], left_on="ID",
                              right_on="USAF_WBAN" )
